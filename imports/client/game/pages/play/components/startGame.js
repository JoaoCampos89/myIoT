...
import {startGame} from '/imports/api/mysensors/validated-methods.js'
...
Template[templateName].helpers({
  gameStatus:function(){
    return Game.findOne({_id:FlowRouter.getParam("id")}).playing;
...
Template[templateName].events({
  "click .js-start-game": function(event, template){
      ...
      var data = {};
      //data.status = false;
      data.gameId = FlowRouter.getParam("id");
          ...
          Meteor.setTimeout(function(){
            ...
            startGame.call(data, function(error, result){
              ...
              if(result){
                ...
                var game = Game.findOne(FlowRouter.getParam("id"));
                if(game){
