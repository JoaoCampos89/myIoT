...
const templateName = 'gameTerminalPlayIndividualPage';
...
Template[templateName].helpers({
  ...
  game:function(){
    return Game.findOne({_id:FlowRouter.getParam('gameId')});
  },
  ...
  shotTime:function(time,playerId){
    var players = Game.findOne({_id:FlowRouter.getParam('gameId')}).players;
